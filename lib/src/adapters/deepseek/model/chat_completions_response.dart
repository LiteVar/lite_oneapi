...
class Message {
  ...
  Audio? audio;
  @Deprecated('Deprecated and replaced by tool_calls.') FunctionModelOld? function_call;
  String? name;
...
class FunctionModelOld {
  ...
  FunctionModelOld({required this.name, required this.arguments});

  factory FunctionModelOld.fromJson(Map<String, dynamic> json) => _$FunctionModelOldFromJson(json);
...
class Usage {
  ...
  Usage({required this.completion_tokens, required this.prompt_tokens, required this.prompt_cache_hit_tokens, required this.prompt_cache_miss_tokens, required this.total_tokens, required this.completion_tokens_details});
...
class CompletionTokensDetails {
  ...
  CompletionTokensDetails({required this.reasoning_tokens});
